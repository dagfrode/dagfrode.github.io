...
> You can be complient with WCAG but still have a webpage that is not accessible to most people.

Start with WCAG 2.2
https://www.w3.org/TR/WCAG22/

Then WCAG 3 - in draft
https://www.w3.org/WAI/standards-guidelines/wcag/wcag3-intro/

Then How People with Disabilities Use the Web
https://www.w3.org/WAI/people-use-web/

knowledge, tools, and processes

- hva er funksjonsneddsettning
...
- [Teaching Accessible Computing - Web book](https://bookish.press/tac)

- [Lost job as IT-systems where not accessable](https://www.nrk.no/trondelag/birgit-risholt-blei-ufor-fra-jobben-i-sintef-mot-sin-vilje-_-it-systema-er-ikkje-universelt-utforma-1.17661414)
- [The Evolution of TRust - game about game theory](https://ncase.me/trust/)

- types of disability - permanent - temporary - situational - https://uxdesign.cc/understanding-accessibility-makes-you-a-better-insert-your-name-here-1f7a15c50e7f

- master Oda om hvordan designe lærringsspill
